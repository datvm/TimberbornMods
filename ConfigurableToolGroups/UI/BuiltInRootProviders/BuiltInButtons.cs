...
public class BeaverGeneratorButtonCustomRootElement(BeaverGeneratorButton button) : BuiltInButtonCustomRootElement<BeaverGeneratorButton>(button) { }
public class BotGeneratorButtonCustomRootElement(BotGeneratorButton button) : BuiltInButtonCustomRootElement<BotGeneratorButton>(button) { }
public class BuilderPrioritiesButtonCustomRootElement(BuilderPrioritiesButton button) : BuiltInButtonCustomRootElement<BuilderPrioritiesButton>(button) { }
public class CursorButtonCustomRootElement(CursorButton button) : BuiltInButtonCustomRootElement<CursorButton>(button) { }
public class DemolishingButtonCustomRootElement(DemolishingButton button) : BuiltInButtonCustomRootElement<DemolishingButton>(button) { }
