...
class Program
{
    ...
    {
        { "Timberborn.BotsUpkeep", "Timberborn.BotUpkeep" },
    };
    ...
    static void Main(string[] args)
    {
        ...
        foreach (var file in Directory.GetFiles(GameAssembliesPath, "Timberborn.*.dll"))
        {
            ...
            var line = $"\t\t<Using Include=\"{name}\"/>";
            output.AppendLine(line);
            Console.WriteLine(line);
        }

        // Write to clipboard
        WindowsClipboard.SetText(output.ToString());
