...
[BindSingleton]
public class PipeArrowRepository : ILoadableSingleton, IUnloadableSingleton
{
    ...
    static readonly Color ArrowColor = new(60 / 255f, 120 / 255f, 183 / 255f);
